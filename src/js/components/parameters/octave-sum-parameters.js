...
function OctaveSumParameters (name, values, callback) {
  ...
  this.values = {
    ...
    remapping: getProp(values, 'remapping', 0.0),
    ...
    randomTranslation: getProp(values, 'randomTranslation', 1.)
  };
}

extendClass(OctaveSumParameters, BaseParameters);

OctaveSumParameters.prototype.initializeElements = function () {
  ...
  this.setElement('randomTranslation', 'range', 'Random translation', {
    softMin: 0,
    softMax: 1,
    hardMin: 0,
    hardMax: 1
...
module.exports = OctaveSumParameters;