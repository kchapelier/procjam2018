  ...
  if (program === null) {
    program = context.createProgram(`#version 300 es
      ...
      vec4 process (in vec2 uv) {
        ...
        float a = fract(length(uv) * 2. / 1.415 * float(tiling) + position);
...
function radialGradientJob (context, inputs, outputs, parameters, done) {
...
module.exports = radialGradientJob;